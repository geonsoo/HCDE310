...
#    include hcde310pictures.html in your Canvas upload
    ...
    for each in first25:
        if each.hasQuestion() == True:
            print each.name + " received " + str(each.commentCount()) + " replies to their question:"
            print str(each.shortMessage())
